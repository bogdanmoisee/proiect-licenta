...
function Signup() {
  ...
  const passwordConfirmationInput = <OutlinedInput id="password-conformation" type={showPassword ? 'text' : 'password'} inputRef={passwordConfirmationRef} endAdornment = {
    <InputAdornment position="end">
      <IconButton
        aria-label="toggle password visibility"
        onClick={() => setShowPassword(!showPassword)}
              ...
              <form onSubmit={handleSubmit}>
                <FormGroup row={true} id="email-group" sx={{marginTop: "1em"}}>
                  <FormControl fullWidth>
                    ...
                    <FormHelperText id="email-helper-text">We will never share your email</FormHelperText>
                  </FormControl>
                </FormGroup>
